...
5. Offer a reminder with `create_schedule` if something is time-sensitive (pack Friday, shop Sunday). Pass `skill` `household` and a brief with the window and the list — not this procedure.

...
description: >
  ...
  "get me ready for this" or "send a recap" without saying meeting.
  Load immediately when the user writes /meeting-prep or
  /consultation-prep.
---

# Meeting and appointment prep

Works for a 1:1, a vendor call, a doctor or school appointment, or a personal conversation they want to walk into prepared.
...
If the user invoked this skill with `/meeting-prep` and no extra brief, ask who the meeting is with, when it is, and what outcome they want. Then pull matching records and files and draft the brief.
